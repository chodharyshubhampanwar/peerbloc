...
import { Search, ArrowRight, Globe, Users, BookOpen } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <header className="bg-white shadow-sm">
        <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-blue-600">Peerbloc</h1>
      ...
      <section className="bg-blue-600 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">Empower Your Future</h2>
          <p className="text-xl mb-8">
            Discover global opportunities for young leaders
          </p>
          <div className="max-w-xl mx-auto relative">
            <input
              type="text"
              placeholder="Search for an experience"
              className="w-full py-3 px-4 pr-12 rounded-full text-gray-900"
            />
            <Search
            ...
            {[
              ...
              >
                <div className={`${program.color} p-6 flex justify-center`}>
                  <program.icon className="text-white" size={48} />
                </div>
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Develop your skills and make a global impact through our{" "}
      ...
      <section className="bg-gray-100 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">
            Join thousands of young leaders making a difference worldwide
          </p>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  href="https://www.facebook.com/peerbloc"
                ...
                <a
                  href="https://www.instagram.com/peerbloc/"
                  className="hover:text-blue-400"
                >
                  <svg
                    className="w-6 h-6"
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center">
            <p>&copy; 2024 Peerbloc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
